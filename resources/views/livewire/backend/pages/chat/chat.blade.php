<div class="chat-wrapper">
        ...
        <div class="chat-sidebar-header">
            <div class="d-flex align-items-center">
                <div class="chat-user-online">
                    <img src="{{ Vite::image('avatar-1.png') }}" width="45" height="45" class="rounded-circle"
                        alt="">
                </div>
            ...
            <div class="chat-tab-menu mt-3">
                <ul class="nav nav-pills nav-justified" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" data-bs-toggle="pill" href="javascript:;" aria-selected="true"
                            role="tab">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-toggle="pill" href="javascript:;" aria-selected="false"
                            tabindex="-1" role="tab">
                    ...
                    <div class="chat-list ps ps--active-y">
                        <div class="list-group list-group-flush">
                            <a href="javascript:;" class="list-group-item">
                                <div class="d-flex">
                                    <div class="chat-user-online">
                                        <img src="{{ Vite::image('avatar-1.png') }}" width="42" height="42"
    ...
    <div class="chat-content ps ps--active-y">
        <div class="chat-content-leftside">
            <div class="d-flex">
                <img src="{{ Vite::image('avatar-1.png') }}" width="48" height="48" class="rounded-circle"
                    alt="">
                <div class="flex-grow-1 ms-2">
